        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-sm">
              ...
              <Link href="/shop" className="text-white hover:text-white transition-colors">
                Loja
              </Link>
              <Link href="/powercamps" className="text-white hover:text-white transition-colors">
                PowerCamps
              </Link>
              <Link href="/coaches" className="text-white hover:text-white transition-colors">
                Coaches
              </Link>
              <Link href="/blog" className="text-white hover:text-white transition-colors">
                Blog
              </Link>
              <Link href="/planos" className="text-white hover:text-white transition-colors">
                Planos
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-sm">
              <Link href="/ajuda" className="text-gray-200 hover:text-white transition-colors">
                Central de Ajuda
              </Link>
              <Link href="/faq" className="text-gray-200 hover:text-white transition-colors">
                FAQ
              </Link>
              <Link href="/politica-privacidade" className="text-gray-200 hover:text-white transition-colors">
                Política de Privacidade
              </Link>
              <Link href="/termos-uso" className="text-gray-200 hover:text-white transition-colors">
                Termos de Uso
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a 
                href="https://www.instagram.com/ocepowerhouse/" 
                target="_blank" 
              ...
              <a 
                href="https://www.youtube.com/@ocepowerhouse" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="text-gray-400 hover:text-yellow-400 transition-colors"
                aria-label="YouTube"
