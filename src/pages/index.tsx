...
const Hero = () => (
  <section
    ...
    // Removi o style={{ width: '100vw' }}
  >
    {/* Imagem de fundo absoluta */}
    <Image
      src="/img/static/hero.png"
      alt="Hugo Prado Neto - Campeão Mundial 2023"
      fill
      style={{ objectFit: 'cover', objectPosition: 'center 10%' }}
      className="z-0 opacity-90 absolute inset-0 rounded-3xl"
      priority
    />
    {/* Overlay escuro mais suave */}
    <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/10 to-black/60 z-10" />
    {/* Texto centralizado */}
    <div className="relative z-20 flex flex-col items-center justify-center text-center px-6 py-16 w-full max-w-3xl mx-auto">
      <h1 className="text-4xl md:text-6xl font-extrabold text-white drop-shadow-lg mb-6 font-hero">
        Somos campeões do mundo
      </h1>
      <Link href="/planos" className="text-lg px-8 py-4 rounded-xl shadow-lg bg-yellow-400 hover:bg-yellow-300 text-blue-900 font-bold transition-all">
        Treine com a OCE
      </Link>
    </div>
  </section>
  ...
  return (
    <>
      ...
      >
        ...
        <motion.div
          className="w-full max-w-2xl aspect-video rounded-xl overflow-hidden shadow-lg flex items-center justify-center bg-black"
        ...
        >
          <iframe
            width="100%"
            height="100%"
            src="https://www.youtube.com/embed/xKBVMaB_AIU?modestbranding=1&autoplay=0&controls=0&showinfo=0&rel=0&enablejsapi=1&version=3&playerapiid=iframe_YTP_1753528908887&origin=https%3A%2F%2Fpowerhousebrasil.com.br&allowfullscreen=true&wmode=transparent&iv_load_policy=3&playsinline=1&mute=0&html5=1&widgetid=1&forigin=https%3A%2F%2Fpowerhousebrasil.com.br%2F&aoriginsup=1&gporigin=https%3A%2F%2Fpowerhousebrasil.com.br%2Fproduto%2Fpalatinose-gel-box-c15-saches%2F&vf=1"
